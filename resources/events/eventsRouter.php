...
Class EventsRouter  extends \HawksNestGolf\Resources\Base\BaseRouter {
    ...
    public function GetRoutes() {
        ...
        $getRoutes['/events'] = function ($request, $response, $args) {
            return self::getInstance()->Get($request, $response,  $args);
        };

        $getRoutes['/events/{id}'] = function ($request, $response, $args) {
            return self::getInstance()->Get($request, $response,  $args);
        };
    ...
    public function PostRoutes() {
        $postRoutes['/events'] = function ($request, $response, $args) {
    ...
    public function PutRoutes() {
        $putRoutes['/events/{id}'] = function ($request, $response, $args) {
    ...
    public function DeleteRoutes() {
        $deleteRoutes['/events/{id}'] = function ($request, $response, $args) {

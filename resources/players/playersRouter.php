...
Class PlayersRouter  extends \HawksNestGolf\Resources\Base\BaseRouter {
    ...
    public function GetRoutes() {
        ...
        $getRoutes['/players'] = function ($request, $response, $args) {
            return self::getInstance()->Get($request, $response,  $args);
        };

        $getRoutes['/players/{id}'] = function ($request, $response, $args) {
            return self::getInstance()->Get($request, $response,  $args);
        };
    ...
    public function PostRoutes() {
        $postRoutes['/players'] = function ($request, $response, $args) {
    ...
    public function PutRoutes() {
        $putRoutes['/players/{id}'] = function ($request, $response, $args) {
    ...
    public function DeleteRoutes() {
        $deleteRoutes['/players/{id}'] = function ($request, $response, $args) {

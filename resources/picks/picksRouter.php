...
Class PicksRouter extends \HawksNestGolf\Resources\Base\BaseRouter {
    ...
    private function __clone(){}
        ...
        public function __construct() {
            $controller = new PicksController();
    ...
    public function GetRoutes() {
        ...
        $getRoutes['/picks'] = function ($request, $response, $args) {
            return self::getInstance()->Get($request, $response,  $args);
        };

        $getRoutes['/picks/{id}'] = function ($request, $response, $args) {
            return self::getInstance()->Get($request, $response,  $args);
        };
    ...
    public function PostRoutes() {
        $postRoutes['/picks'] = function ($request, $response, $args) {
    ...
    public function PutRoutes() {
        $putRoutes['/picks/{id}'] = function ($request, $response, $args) {
    ...
    public function DeleteRoutes() {
        $deleteRoutes['/picks/{id}'] = function ($request, $response, $args) {

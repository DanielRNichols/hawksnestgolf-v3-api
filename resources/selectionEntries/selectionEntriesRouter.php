...
Class SelectionEntriesRouter extends \HawksNestGolf\Resources\Base\BaseRouter {
    ...
    public function __construct() {
            $controller = new SelectionEntriesController();
    ...
    public function GetRoutes() {
        ...
        $getRoutes['/selectionentries'] = function ($request, $response, $args) {
            return self::getInstance()->Get($request, $response,  $args);
        };

        $getRoutes['/selectionentries/{id}'] = function ($request, $response, $args) {
            return self::getInstance()->Get($request, $response,  $args);
        };
    ...
    public function PostRoutes() {
        $postRoutes['/selectionentries'] = function ($request, $response, $args) {
    ...
    public function PutRoutes() {
        $putRoutes['/selectionentries/{id}'] = function ($request, $response, $args) {
    ...
    public function DeleteRoutes() {
        $deleteRoutes['/selectionentries/{id}'] = function ($request, $response, $args) {

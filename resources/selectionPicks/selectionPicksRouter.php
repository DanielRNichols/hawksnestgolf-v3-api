...
Class SelectionPicksRouter extends \HawksNestGolf\Resources\Base\BaseRouter {
    ...
    public function __construct() {
            $controller = new SelectionPicksController();
    ...
    public function GetRoutes() {
        ...
        $getRoutes['/selectionpicks'] = function ($request, $response, $args) {
            return self::getInstance()->Get($request, $response,  $args);
        };

        $getRoutes['/selectionpicks/{id}'] = function ($request, $response, $args) {
            return self::getInstance()->Get($request, $response,  $args);
        };
    ...
    public function PostRoutes() {
        $postRoutes['/selectionpicks'] = function ($request, $response, $args) {
    ...
    public function PutRoutes() {
        $putRoutes['/selectionpicks/{id}'] = function ($request, $response, $args) {
    ...
    public function DeleteRoutes() {
        $deleteRoutes['/selectionpicks/{id}'] = function ($request, $response, $args) {

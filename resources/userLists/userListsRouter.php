...
Class UserListsRouter extends \HawksNestGolf\Resources\Base\BaseRouter {
    ...
    public function __construct() {
        $controller = new UserListsController();
    ...
    public function GetRoutes() {
        ...
        $getRoutes['/userlists'] = function ($request, $response, $args) {
            return self::getInstance()->Get($request, $response,  $args);
        };

        $getRoutes['/userlists/{id}'] = function ($request, $response, $args) {
            return self::getInstance()->Get($request, $response,  $args);
        };
    ...
    public function PostRoutes() {
        $postRoutes['/userlists'] = function ($request, $response, $args) {
    ...
    public function PutRoutes() {
        $putRoutes['/userlists/{id}'] = function ($request, $response, $args) {
    ...
    public function DeleteRoutes() {
        $deleteRoutes['/userlists/{id}'] = function ($request, $response, $args) {

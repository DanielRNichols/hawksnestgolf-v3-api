...
Class TeamsRouter  extends \HawksNestGolf\Resources\Base\BaseRouter {
...
//        $getRoutes['/teams'] = function ($request, $response, $args) {
//            return self::getInstance()->Get($request, $response,  $args);
//        };

        $getRoutes['/teams/{id}'] = function ($request, $response, $args) {
            return self::getInstance()->Get($request, $response,  $args);
        };
...
//        $postRoutes['/teams'] = function ($request, $response, $args) {
...
//        $putRoutes['/teams/{id}'] = function ($request, $response, $args) {
...
//        $deleteRoutes['/teams/{id}'] = function ($request, $response, $args) {
